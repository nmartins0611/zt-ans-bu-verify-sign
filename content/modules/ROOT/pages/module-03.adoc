...
Go to the `Automation-Controller` tab and log in using the credentials below. Navigate to **Resources** → **Credentials** and click **Add**.
...
Next, navigate to **Resources** → **Projects** and click **Add**. Fill out the form with the following details:
